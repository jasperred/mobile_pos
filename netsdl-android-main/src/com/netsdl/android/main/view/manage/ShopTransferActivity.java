...
OnItemLongClickListener {
	...
	private void init() {
				...
				.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						try {
							...
							Toast.makeText(ShopTransferActivity.this,
		...
		// 日期
		((EditText) this.findViewById(R.id.transferDateEditText))
		...
		scanEditText.setOnKeyListener(new OnKeyListener() {
			public boolean onKey(View v, int keyCode, KeyEvent event) {
				try {
					...
					Toast.makeText(ShopTransferActivity.this, e.getMessage(),
	...
	private void transferConfirm() {
		...
		String returnDate = ((EditText) this
				.findViewById(R.id.transferDateEditText)).getText().toString();
		Spinner whSpinner = (Spinner) this.findViewById(R.id.transferToShopSpinner);
		...
		head.put(PosTable.COLUMN_BO_TYPE,"MV");
	...
	private void initContral() {
		...
		try {
			Object[][] cl = DatabaseHelper.getMultiColumn(getContentResolver(),
					new String[] { Constant.CUST_TYPE, Constant.CUST_ST },
			...
			if (cl != null && cl.length > 0) {
				...
				Spinner custSpinner = (Spinner) this
						.findViewById(R.id.transferToShopSpinner);
